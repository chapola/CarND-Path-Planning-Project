...
//                if (d>(2+4*lane-2) && d<(2+4*lane+2)) {
                    ...
                    //check the check car is ahead of my car
...
//
//                    }
                cout<<"check_car_lane:::::"<<check_car_lane<<"::::"<<lane<<endl;
                    if (check_car_lane==lane && check_car_s>car_s && check_car_s-car_s<30) {
                        car_ahead=true;
                        cout<<"Car is ahead::::"<<endl;
                    }else if(lane-check_car_lane>0&&(car_s-30<check_car_s && car_s+30>check_car_s)){
                        car_left=true;
                         cout<<"car_left::::"<<endl;
                    }else if (lane-check_car_lane<0 && (car_s-30<check_car_s && car_s+30>check_car_s)){
                        car_right=true;
...
//                ref_vel+=0.224;
//                cout<<"ref vel f:::::"<<ref_vel<<":::"<<too_close<<endl;
//            }
//
            ...
            if (car_ahead) {
                if (!car_left&&lane>0) {
                    ...
                    ref_vel-=0.224;
//                    cout<<"ref vel t:::::"<<ref_vel<<":::"<<too_close<<endl;
